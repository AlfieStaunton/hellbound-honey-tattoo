...
document
  ...
  .addEventListener("submit", function (event) {
    ...
    if (age === "no") {
      alert(
        "Unfortunately, you must be at least 18 years old to get a tattoo. We cannot process this booking."
      );
      return;
    }
    ...
    //success
    alert(
      "Thank you for choosing Hellbound Honey for your next tattoo! We look forward to working with you!"
    );
